...
static void MTTryActivateDirectYouTubeScene(id scene){
    ...
    @try{
        ...
        if([scene respondsToSelector:act]){
            ...
            if(!MTV(scene,@"clientProcess")){MTLog(@"[BIND-PROBE] direct scene foreground but client missing; probing launch services");MTProbeActivationServices();MTProbeValidClientIdentity();}
